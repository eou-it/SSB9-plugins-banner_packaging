...
target(genSAMLProperties: "Creates saml_configuration.properties file holding SAML Configuration required!") {
    ...
    def appName = "${metadata.'app.name'}" + ".jks"
    ...
    def content = """|#This file is automatically generated and contains SAML Configuration specific properties.
                     ...
                     |#
                     |#
                     |# This is the Issuer name provided in the EIS server
                     |alias=''
                     ...
                     |#This is Assertion URL to be mentioned during the Service provider configuration in EIS server
                     |serviceAssertionLocation=''
                     |#This is the URL of the ID provider / EIS to be configured. (https://<HOSTNAME>:<PORT>/samlsso)
                     |identityProviderLocation=''
                     |# KEYSTORE GENERATION / Service PROVIDER Certificate GENERATION. Note - IF you already have a JKS file and certificate then please mark certificateertificateAvailable as true; bydefault its false;
